...
export const LegalModal: React.FC<LegalModalProps> = ({ isOpen, onClose, title, content }) => {
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
      ...
      {/* Modal Content - Using #050505 to match site background exactly */}
      <div className="relative w-full max-w-lg bg-[#050505] border border-white/10 rounded-2xl shadow-[0_0_100px_rgba(138,43,226,0.2)] flex flex-col max-h-[85vh] animate-modal-pop overflow-hidden">
        ...
        {/* Header - Slightly lighter #0a0a0a for contrast */}
        <div className="flex items-center justify-between p-6 border-b border-white/5 bg-[#0a0a0a]">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-neonPurple/10 rounded-lg border border-neonPurple/20 shadow-[0_0_15px_rgba(138,43,226,0.1)]">
          ...
          <button 
            onClick={onClose} 
            className={`p-2 rounded-lg hover:bg-white/10 transition-all duration-500 ease-out ${canClose ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8 pointer-events-none'}`}
            aria-label="Fechar"
          >
        ...
        {/* Scrollable Text - Custom scrollbar defined in index.html */}
        ...
        {/* Footer with Timer Button - Matching header color */}
